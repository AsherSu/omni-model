...
import cn.ashersu.omni.model.client.VolcEngineApi;
...
public class AliService {
     ...
     */
    public AliService(final String token) {
     ...
     */
    public AliService(final String token, final Duration timeout) {
     ...
     */
    public AliService(final VolcEngineApi api) {
        this.api = api;
     ...
     */
    public AliService(final VolcEngineApi api, final ExecutorService executorService) {
        this.api = api;
