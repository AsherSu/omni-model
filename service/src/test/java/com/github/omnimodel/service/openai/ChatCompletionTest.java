...
import cn.ashersu.omni.model.service.*;
...
class ChatCompletionTest {
    ...
    String token = cn.ashersu.omni.model.service.TestConfig.getOpenAiApiKey();
...
//                .logitBias(new HashMap<>())
        ...
        List<ChatCompletionChoice> choices = aliService.createChatCompletion(chatCompletionRequest).getChoices();
        assertEquals(5, choices.size());
    }
