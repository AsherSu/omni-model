...
public class SimpleChatMessage extends ChatMessage{
	...
	public SimpleChatMessage(String role, String content, String name) {
		this.role = role;
		this.content = content;
		this.name = name;
	}
	...
	public static final class Builder {
		...
		public SimpleChatMessage build() {
			SimpleChatMessage simpleChatMessage = new SimpleChatMessage(role, content);
			simpleChatMessage.setName(name);
			simpleChatMessage.setFunctionCall(functionCall);
			simpleChatMessage.setReasoningContent(reasoningContent);
